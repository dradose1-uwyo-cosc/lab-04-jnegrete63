...
print(f"{len(max_temps)}")

average_temp = 0
for H_temp in max_temps:
    average_temp = (average_temp + H_temp)
average_max_temp = average_temp/365
print(f"The average high temp in Laramie is {average_max_temp}")


average_low_temp = 0
for L_temp in min_temps:
    average_low_temp = (average_low_temp + L_temp)
average_min_temp = average_low_temp/365
print(f"The average low temp in Laramie is {average_min_temp}")

# For the next part, determine the highest and lowest recorded temperatures.
# HINT: You can find this information without using any logic or looping.

highest_rec_temp = max(max_temps)

lowest_rec_temp = min(min_temps)

print(f"The highest recorded temp in Laramie is {highest_rec_temp}, and the lowest recorded temp was {lowest_rec_temp}")
